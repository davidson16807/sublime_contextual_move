...
`Ctrl+;`| Move to the beginning/end of the line/document. Subsequent keypresses to `Ctrl+IJKL` will return to the default behavior | `;` delimits lines in most C-like languages (`Ctrl+enter` is already taken)
